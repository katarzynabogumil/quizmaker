...
function display_question (n, questions, quiz, score) {
    ...
    if (n === questions.length) {
        container.innerHTML = `
            ...
            Your score is ${score}/${questions.length}.<br><br>
        `;
        ...
        switch (question.type) {
            ...
            case 'true_or_false':
                answers_div.innerHTML = `
                    <div class="container m-2 mx-auto">
                        <div class="row">
                            <div id="answer-true" class="answer col-sm btn btn-light m-1">True</div>
                            <div id="answer-false" class="answer col-sm btn btn-light m-1">False</div>
                        </div>
                    </div>
                `;
                container.append(answers_div);
